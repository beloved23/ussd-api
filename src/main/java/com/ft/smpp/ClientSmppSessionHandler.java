...
public class ClientSmppSessionHandler extends DefaultSmppSessionHandler {
	...
	/**
	 * IMPORTANT: This one handle message in async mode to boost performance for the app
	 */
	@SuppressWarnings("rawtypes")
	@Override
	public void fireExpectedPduResponseReceived(PduAsyncResponse pduAsyncResponse) {
        ...
        if (pduAsyncResponse.getResponse().getCommandId() == SmppConstants.CMD_ID_SUBMIT_SM_RESP) {
        	logger.debug("Got a SubmitSmResp: {}", pduAsyncResponse.getResponse());
        	PduRequest requestPdu = pduAsyncResponse.getRequest();
        	logger.debug("TODO: Save the Notification here: {}", requestPdu);
        }
